...
<!-- 出勤・退勤時間（表示と修正） -->
            <div class="detail-form__item">
                ...
                <input class="detail-form__input" type="time" name="clock_in" value="{{ $clock_in ?? '' }}" {{ $isLocked ? 'disabled' : '' }}>
                <span>～</span>
                <input class="detail-form__input" type="time" name="clock_out" value="{{ $clock_out ?? '' }} {{ $isLocked ? 'disabled' : '' }}">
...
<!-- 休憩１（表示と修正） -->
            <div class="detail-form__item">
                ...
                <input class="detail-form__input" type="time" name="break1_start" value="{{ $break1_start ?? '' }}" {{ $isLocked ? 'disabled' : '' }}>
                <span>～</span>
                <input class="detail-form__input" type="time" name="break1_end" value="{{ $break1_end ?? '' }}" {{ $isLocked ? 'disabled' : '' }}>
                <div class="error-messages">
                @error('break1_start') 
                    {{ $message }}
                @enderror
...
<!-- 休憩２（表示と修正） -->
            <div class="detail-form__item">
                ...
                <input class="detail-form__input" type="time" name="break2_start" value="{{ $break2_start ?? '' }}" {{ $isLocked ? 'disabled' : '' }}>
                <span>～</span>
                <input class="detail-form__input" type="time" name="break2_end" value="{{ $break2_end ?? '' }}" {{ $isLocked ? 'disabled' : '' }}>
                @error('break2_start') 
                    {{ $message }}
                @enderror
                @error('break2_end')
